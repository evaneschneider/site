...
* A virial mass of $$5\times 10^{10}$$ (this is a guess, roughly based on the $$v_\mathrm{max}$$-halo mass relationship in Maller & Bullock (2004).
...
The above parameters lead to a central surface density of $$\sim100 M_\odot / \mathrm{pc}^2$$, which is consistent with M82's observed central surface density. M82 also contains a central stellar bar, which considerably affects the shape of the stellar rotation curve in the inner kpc. Below is my fit to the stellar rotation curve of Greco (2012), using only the disk and halo components given above:
