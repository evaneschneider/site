...
The above parameters lead to a central surface density of $$\sim 100 M_{\odot} / \mathrm{pc}^2$$, which is consistent with M82's observed central surface density. M82 also contains a central stellar bar, which considerably affects the shape of the stellar rotation curve in the inner kpc. Below is my fit to the stellar rotation data of Greco (2012), using only the disk and halo components given above:
