...
<div style="text-align: center">
$$x = r \mathrm{cos}(\phi), \mathrm{and} y = r \mathrm{sin}(\phi),$$
</div>
I get
<div style="text-align: center">
$$v_{x} = v_{r}\mathrm{cos}\phi - v_{\phi} \mathrm{sin}(\phi), \mathrm{and} 
v_{y} = v_{r}\mathrm{sin}(\phi) + v_{\phi}\mathrm{cos}(\phi)$$
</div>
(where $$v_{\phi} = r \frac{d(\phi)}{dt}$$). Since $$v_{r} = 0$$ for the Gresho problem,
that gives
<div style="text-align: center">
$$v_{x} = -\mathrm{cos}(\phi) v_{\phi}, \mathrm{and} v_{y} = \mathrm{cos}(\phi) v_{\phi}.$$
</div>
